...
namespace Agents.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            Models.db_AgentsEntities db = new db_AgentsEntities();

            var business = db.Businesses.Find(model.UserName);

            if (ModelState.IsValid && business != null && business.Password == model.Password)
            {
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Login", new { returnUrl = Url.Action("Index", "Homes") });
        }
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                   ...
                   var b = db.Businesses.Find(model.UserName);
                   if (b != null) throw new Exception("用户名已存在！");

                   if (model.Password != model.ConfirmPassword) throw new Exception("两次密码不一致！");
